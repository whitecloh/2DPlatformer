...
public class RangedEnemy : MonoBehaviour
{
    ...
    public float RebornCooldown
    {
        get
        {
            return _animator.GetFloat(AnimationsString.rebornCooldown);
        }
        private set
        {
            _animator.SetFloat(AnimationsString.rebornCooldown, Mathf.Max(value, 0));
        }
    }
    private void Update()
    {
        ...
        if (!_damagable.IsAlive&& RebornCooldown > 0)
        {
            RebornCooldown -= Time.deltaTime;
        }
    }
